...
<script src="<?php echo base_url('application/assets/js/price_format.js'); ?>"></script>
...
<script>
    ...
    ;
    function salvaBairro() {
        $.ajax({
            url: '<?php echo base_url('index.php/cliente/salvar_bairro'); ?>',
            type: 'POST',
            data: {
                'acao': 'listaRua',
