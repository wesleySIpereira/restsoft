                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="<?php echo date('d/m/Y', strtotime($cliente[0]->nascimento)); ?>" required type="text" placeholder="__/__/____" name="txtdatanascimento" id="datanascimento">
                                </div>
                                <div class="form-group">
                                    <label>CPF</label>
