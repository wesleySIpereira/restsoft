...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form role="form" id="form_cliente" action="<?php echo base_url('index.php/cliente/salva'); ?>" method="post">
                                ...
                                <div class="form-group">
                                    <label>NOME</label>
                                    <input class="form-control" value="<?php if (isset($_SESSION['campos'])) {
        ...
        echo $_SESSION['campos']['pessoa_nascimento'];
                                ...
                                <div class="form-group">
                                    <label>CPF</label>
                                    <input type="text" class="form-control"  value="<?php if (isset($_SESSION['campos'])) {
        ...
        echo $_SESSION['campos']['pessoa_pai'];
                                ...
                                <div class="form-group">
                                    <label>E-MAIL</label>
                                    <input  class="form-control" required type="email" value="<?php if (isset($_SESSION['campos'])) {
        ...
        echo $_SESSION['campos']['pessoa_celular'];
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" value="<?php if (isset($_SESSION['campos'])) {
...
?>
                                ...
                                <div class="form-group">
                                    <label>NUMERO</label>
                                    <input type="text" class="form-control" id="txtnumero" value="<?php if (isset($_SESSION['campos'])) {
