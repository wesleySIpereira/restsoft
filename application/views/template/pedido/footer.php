...
<script>
    $(document).ready(function () {
        $('#lista_clientes_pedidos').DataTable({
            "language": {
...
<script>
    ...
    function atualizaCompra(prod,qtd) {



        $.ajax({
            url: '<?php echo base_url('index.php/pedido/update_produto'); ?>',
            type: 'POST',
            data: {
            ...
            success: function (msg) {
              ...
              window.location.href = "<?php echo base_url('index.php/pedido/fazer-pedido/'); ?>"+idcliente;
