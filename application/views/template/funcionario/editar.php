...
<div id="page-wrapper">
    ...
    <form role="form" id="form_cliente" action="<?php echo base_url('index.php/funcionario/atualiza/' . $funcionario[0]->id_funcionario); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="txtbairro" id="bairro" required onchange="listarRua()">
                                    <option value="<?php echo $funcionario[0]->id_bairro; ?>" selected><?php echo $funcionario[0]->nm_bairro; ?></option>
                                    <?php
                            ...
                            <div class="form-group" id="select_rua">
                                ...
                                <select class="form-control" name="txtrua" id="bairro" required>
                                    <option value="<?php echo $funcionario[0]->id_rua; ?>" selected><?php echo $funcionario[0]->nm_rua; ?></option>
                            ...
                            <div class="form-group">
                                <label>NUMERO</label>
                                <input type="text" class="form-control" id="txtnumero" value="<?php echo $funcionario[0]->rua; ?>" required name="txtnumero" >
                ...
                <div class="row">
                    <div class="col-lg-12">                        
                        <div class="form-group">
                            <div class="form-group">
                                <label>NOME</label>
                                <input class="form-control" value="<?php echo $funcionario[0]->nome; ?>"  name="txtnome" required>

                            </div>
                            <div class="form-group">
                                <label>DATA DE NASCIMENTO</label>
                                <input class="form-control" value="<?php echo $funcionario[0]->nascimento; ?>" required type="text" placeholder="__/__/____" name="txtdatanascimento" id="datanascimento">
                            </div>
                            <div class="form-group">
                                <label>CPF</label>
                                <input type="text" class="form-control"  value="<?php echo $funcionario[0]->cpf; ?>" placeholder="___.___.___-__" name="txtcpf" id="cpf" >
                            </div>
                            <div class="form-group">
                                <label>RG</label>
                                <input type="text" class="form-control" value="<?php echo $funcionario[0]->rg; ?>"   name="txtrg" id="rg" >
                            </div>
                            <div class="form-group">
                                <label>MÃE</label>
                                <input type="text" class="form-control" value="<?php echo $funcionario[0]->mae; ?>" required  name="txtmae"  >
                            </div>
                            <div class="form-group">
                                <label>PAI</label>
                                <input type="text" class="form-control" value="<?php echo $funcionario[0]->pai; ?>" required  name="txtpai"  >
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">                        
                        <div class="form-group">
                            <div class="form-group">
                                <label>E-MAIL</label>
                                <input  class="form-control" required type="email" value="<?php echo $funcionario[0]->email ?>"  name="txtemail" placeholder="exemplo@email.com"  >
                            </div>
                            <div class="form-group">
                                <label>CELULAR</label>
                                <input type="text" class="form-control" value="<?php echo $funcionario[0]->celular; ?>" required placeholder="(__)-____-____" name="txtcelular" id="celular"  >
                            </div>
                            <div class="form-group">
                                <label>TELEFONE</label>
                                <input type="text" required class="form-control" value="<?php echo $funcionario[0]->telefone; ?>" placeholder="(__)-____-____"  name="txttelefone" id="telefone"  >
                            </div>
